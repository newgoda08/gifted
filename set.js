...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~zqZ2FbrK#OADjI0BblhDN4DlkmLza5VSX-5JOzo-O0Nxk3pUgPRc", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
SUDO_NUMBERS: process.env.SUDO_NUMBERS || "254728746852,254742063632", //Add multiple Numbers with Country Codes without (+) Separated by Comma...
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*`✅️ඔයාගෙ ස්ටෙටස් මම බැලුවා..මගෙත් බලන්ණ හොදේ..🥺💝`*", // // Input Yours custom...
MODE: process.env.MODE || "public",
OWNER_NUMBER: process.env.OWNER_NUMBER || "94743356701", // Only 1 owner Number Here, others Add to sudo numbers...
